              ...
              <div class="card-body p-5">
                ...
                <form method="post" action="login.php">
                  ...
                  <div class="form-label-group">
                    <input type="email" name="email" id="inputEmail" class="form-control-lg mb-3" placeholder="Email address" required autofocus>
                    <label for="inputEmail" class="sr-only">Email address</label>
                  </div>
                  <div class="form-label-group">
                    <input type="password" name="password" id="inputPassword" class="form-control-lg mb-3" placeholder="Password" required>
