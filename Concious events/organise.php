...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>
      Organise a spirtiual event    </title>
              ...
              <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5 bg-black">
                  <div class="card-body p-5">
                    <h2 class="card-title text-center mb-5">Error</h2>
                    <a href="login.php">Login</a> or <a href="register.php">Sign up</a> to organise an event.
                  </div>
                </div>
              </div>
            </div>